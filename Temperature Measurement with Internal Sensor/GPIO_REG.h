...
#define GPIO_IEV_OFFSET      0X0C
#define GPIO_IM_OFFSET       0x10
#define GPIO_ICR_OFFSET      0x1C
#define GPIO_MIS_OFFSET      0x18
#define GPIO_IS_OFFSET       0x004   // Input Sense
#define GPIO_IBE_OFFSET      0x008   // Interrupt Both Edges
